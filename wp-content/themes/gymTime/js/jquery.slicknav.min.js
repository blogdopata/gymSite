 ...
 * licensed under MIT
 */
//console.log('Impreso desde slickNav');
    ...
    Keyboard = {
        ...
        a.prototype._visibilityToggle = function(t, n, a, i, s) {
            ...
            var c = this,
                ...
                u = 0;
            a && (u = d.duration),
                t.hasClass(o + "_hidden") ? (t.removeClass(o + "_hidden"), s || d.beforeOpen(i), "jquery" === d.animations ? t.stop(!0, !0).slideDown(u, d.easingOpen, function() {
                    r(i, n)
